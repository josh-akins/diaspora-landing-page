          ...
          <div className="flex flex-wrap gap-8">
            <div className="w-full sm:w-auto">
              <nav className="flex space-x-6">
                <Link to="#features" className="text-[#667085] hover:text-[#3da647]">Features</Link>
                <Link to="#pricing" className="text-[#667085] hover:text-[#3da647]">Pricing</Link>
                <Link to="#businesses" className="text-[#667085] hover:text-[#3da647]">Businesses</Link>
                <Link to="#hmos" className="text-[#667085] hover:text-[#3da647]">HMOs</Link>
                <Link to="#chat" className="text-[#667085] hover:text-[#3da647]">Chat With Us</Link>
                <Link to="#download" className="text-[#667085] hover:text-[#3da647]">Download App</Link>
              </nav>
            </div>
