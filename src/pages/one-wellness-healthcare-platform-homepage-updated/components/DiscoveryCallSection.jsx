...
const DiscoveryCallSection = () => {
  ...
  return (
    <section id="chat-with-our-expert" className="w-full flex justify-center items-center py-16 px-2 bg-white">
      <div className="w-full max-w-6xl bg-[#FFE9CF] rounded-3xl flex flex-col md:flex-row items-center md:items-stretch shadow-lg overflow-hidden">
        {/* Left Side */}
        <div className="flex-1 flex flex-col justify-center items-center md:items-start pl-8 lg:pl-32 pr-8 py-12 md:py-16">
          ...
          />
          <div className="text-[#013B00] text-base mb-2">Book a Discovery call with Victoria</div>
          <div className="text-[#3DA647] text-3xl md:text-4xl font-bold mb-4">30 mins discovery call</div>
          <div className="text-[#013B00] text-sm font-light mb-8 max-w-md">
          ...
          <div className="flex gap-12 mt-4">
            <div>
              ...
              <div className="text-[#013B00] text-xs mt-1">Duration</div>
            </div>
            <div>
              <div className="text-[#3DA647] text-lg font-bold">Google Meet</div>
              <div className="text-[#013B00] text-xs mt-1">Location</div>
            </div>
          </div>
        </div>
        {/* Right Side - Calendar */}
        <div className="flex-1 flex justify-center items-center bg-transparent p-8 md:p-12">
          <div 
            ...
            className="cursor-pointer bg-white rounded-2xl shadow-md p-6 md:p-10 min-w-[320px] max-w-[360px] border-2 border-[#A3E3B7]"
          >
            ...
            <div className="grid grid-cols-7 gap-2 text-center text-[#176B1B]">
              ...
              <div className="bg-[#3DA647] text-white rounded-full w-8 h-8 flex items-center justify-center mx-auto">9</div>
